...
var files = ["milk_history.mp3", // 0
            "milk_olympics.mp3", // 1
            "milk_ufos.mp3", // 2
            ];

						var nameBoy = ["Milk History", // 0
						            "Milk Olympics", // 1
						            "Milk UFOs", // 2
						            ];
...
function createAudioElements() {
    for (f in files) {
        var audioString = "<audio id=\"audio-" + f + "\" class=\"audio\" preload=\"true\"><source src=\"radio/" + files[f] + "\"></audio>";
...
function createAudioPlayers() {
    for (f in files) {
        var playerString = "<h1 class=\"forradio\">"+nameBoy[f]+"</h1><div id=\"audioplayer-" + f + "\" class=\"audioplayer\"><button id=\"playbutton-" + f + "\" class=\"play playbutton\"></button><div id=\"timeline-" + f + "\" class=\"timeline\"><div id=\"playhead-" + f + "\" class=\"playhead\"></div></div></div>";
